...
| **Тестовое покрытие** | 7 / 10 | ~14.5k строк тестов, 69 файлов, 119 API-тестов; покрыты Transit/SSH/TOTP/JWT/LDAP; не хватает fuzz и длительного soak |
| **Релиз-инженерия** | 8 / 10 | goreleaser, cosign, SBOM, distroless, CI с lint/gosec |
| **Документация** | 9 / 10 | Единая структура docs/, 25 гайдов, ручные тест-кейсы, актуальна на v1.35.0 |
