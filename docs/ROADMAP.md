...
> Состояние: M0–M28 завершены (v0.28.0). Следующий шаг: внешний security audit (QA-3) → v1.0 GA.

---

## Текущее состояние (v0.28.0)
...
| Renewable tokens with MaxTTL (Renewable flag, max_ttl cap, lookup-self, renew-self) | ✅ |
