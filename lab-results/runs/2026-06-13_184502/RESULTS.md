# Lab test run 2026-06-13_184502

**Date:** 2026-06-13 18:45:58
**Host:** Windows
...
| L-SETUP | Local server + root token | local:8202 | PASS | tuck_SIx2i-eoyVTK9h6zaV0fQ-S6XiYayrshRI6csYUf-YY |
...
| 3b | KV get | local | PASS | {"created_at":"2026-06-13T15:45:05Z","path":"db/password","value":"supersecret123"} |
...
| 6 | Token create | local | PASS | tuck_dQ62CUdrOtxcbdyFYzITBTaaImrIxv4FvwvLUtMb01Y |
| 7a | Manual seal | local | PASS | status 200 |
| 7b | Sealed 503 | local | PASS | status 503 |
| 10 | Persist restart | local | PASS | {"created_at":"2026-06-13T15:45:07Z","path":"persist-test","value":"persist-ok"} |
...
| K8S-1 | Health | minikube | PASS | {"build_date":"unknown","commit":"unknown","ha_enabled":false,"sealed":false,"uptime_seconds":103... |
| 8 | K8s SA auth login+read | minikube | PASS | ok |
| 9a | PUT secret for operator | minikube | PASS | status 204 |
| 9b | TuckSecret operator sync | minikube | PASS | got=lab-run-2026-06-13_184502 want=lab-run-2026-06-13_184502 |
