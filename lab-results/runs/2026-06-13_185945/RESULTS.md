# Lab test run 2026-06-13_185945

**Date:** 2026-06-13 19:00:44
**Host:** Windows
...
| L-SETUP | Local server + root token | local:8202 | PASS | tuck_WCVYZ_JLc4WyjgrIyA7EDyBjZbHdPtjeqe_lGDW4zTk |
...
| 3b | KV get | local | PASS | {"created_at":"2026-06-13T15:59:51Z","path":"db/password","value":"supersecret123"} |
...
| 6 | Token create | local | PASS | tuck_-yyM44keJy7cNBZ8B5I0sr8cwj5QHm6QlaK3m91Y9EI |
| 7a | Manual seal | local | PASS | status 200 |
| 7b | Sealed 503 | local | PASS | status 503 |
| 10 | Persist restart | local | PASS | {"created_at":"2026-06-13T15:59:53Z","path":"persist-test","value":"persist-ok"} |
...
| K8S-1 | Health | minikube | PASS | {"build_date":"unknown","commit":"unknown","ha_enabled":false,"sealed":false,"uptime_seconds":989... |
| 8 | K8s SA auth login+read | minikube | PASS | ok |
| 9a | PUT secret for operator | minikube | PASS | status 204 |
| 9b | TuckSecret operator sync | minikube | PASS | got=lab-run-2026-06-13_185945 want=lab-run-2026-06-13_185945 |
